...
$editpanel.on("click", '.segmented-options.single-segmented-option li a', function(e) {
    e.preventDefault();
...
/* FIELDS */
$editpanel.on('change paste', '.panel-edit-item .mfn-form .field-to-object, .panel-edit-item .mfn-form .mfn-field-value', function() {
    getFieldChange($(this));
});
